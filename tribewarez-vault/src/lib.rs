...
pub mod tribewarez_vault {
    ...
    pub fn create_vault(
        ...
        treasury.total_vaults = treasury.total_vaults.checked_add(1)
    ...
    pub fn deposit(ctx: Context<Deposit>, amount: u64) -> Result<()> {
        ...
        require!(ctx.accounts.treasury.is_active, VaultError::TreasuryInactive);
        ...
        treasury.total_deposited = treasury.total_deposited.checked_add(amount)
            .ok_or(VaultError::MathOverflow)?;
    ...
    pub fn create_escrow(
        ...
        require!(amount > 0, VaultError::InvalidAmount);
        require!(release_time > Clock::get()?.unix_timestamp, VaultError::InvalidReleaseTime);
    ...
    pub fn release_escrow(ctx: Context<ReleaseEscrow>) -> Result<()> {
        ...
        require!(clock.unix_timestamp >= escrow.release_time, VaultError::EscrowNotReady);
    ...
    pub fn cancel_escrow(ctx: Context<CancelEscrow>) -> Result<()> {
        ...
        require!(!escrow.is_released, VaultError::AlreadyReleased);
        require!(!escrow.is_cancelled, VaultError::EscrowCancelled);
        require!(clock.unix_timestamp < escrow.release_time, VaultError::CannotCancelAfterRelease);
    ...
    pub fn extend_lock(ctx: Context<UpdateVault>, new_lock_until: i64) -> Result<()> {
        ...
        require!(new_lock_until > vault.lock_until, VaultError::CannotReduceLock);
